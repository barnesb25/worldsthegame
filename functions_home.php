...
function showHomeInfo($getPage_connection2) {
	...
	echo "                    <input name=\"register_username\" type=\"text\" class=\"form-control\" id=\"register_username\" placeholder=\"Username\" />\n";
	echo "                  </div>\n";
	echo "                  <div class=\"form-group form-group-sm\">\n";
	echo "                    <label for=\"register_password\">Password</label>\n";
	echo "                    <input name=\"register_password\" type=\"password\" class=\"form-control\" id=\"register_password\" placeholder=\"Password\" />\n";
	echo "                  </div>\n";
	echo "                  <div class=\"form-group form-group-sm\">\n";
	echo "                    <label for=\"register_confirm_password\">Confirm Password</label>\n";
	echo "                    <input name=\"register_confirm_password\" type=\"password\" class=\"form-control\" id=\"register_confirm_password\" placeholder=\"Password\" />\n";
	echo "                  </div>\n";
	echo "                  <div class=\"form-group form-group-sm\">\n";
	echo "                    <label for=\"register_nation\">Nation Name</label>\n";
	echo "                    <input name=\"register_nation\" type=\"text\" class=\"form-control\" id=\"register_nation\" placeholder=\"Russia\" />\n";
	echo "                  </div>\n";
	echo "                  <div class=\"form-group form-group-sm\">\n";
	echo "                    <label for=\"register_formal\">Formal Nation Name</label>\n";
	echo "                    <input name=\"register_formal\" type=\"text\" class=\"form-control\" id=\"register_formal\" placeholder=\"Union of Soviet Socialist Republics\" />\n";
	echo "                  </div>\n";
	echo "                  <div class=\"form-group form-group-sm\">\n";
	echo "                    <button value=\"register\" name=\"page\" type=\"submit\" class=\"btn btn-primary btn-lg\">Register</button>\n";
	echo "                    <br /><br />\n";
							...
							if (isset($finalTiles[$j])) {
								if ($finalTiles[$j] > 0) {
									...
									if ($capitalBuilt === false) {
										addImprovementInfo($getPage_connection2, $tileInfo2["continent"], $tileInfo2["xpos"], $tileInfo2["ypos"], 1, 1, array(0=>0), array(0=>$new_userid)); // add capital
										addImprovementInfo($getPage_connection2, $tileInfo2["continent"], $tileInfo2["xpos"], $tileInfo2["ypos"], 4, 1, array(0=>0), array(0=>$new_userid)); // add farm
										$capitalBuilt = true;
									} // if
								} // if
							} // if
